    ...
    public static EventHandler<ActionEvent> thoiKyInfoWindow(String tenThoiKy){
        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                gridPane.add(new Text("Tên triều đại: "),0,0);
                gridPane.add(tenTrieuDai,1,0);
                gridPane.add(new Text("Thời kỳ: "),0,1);
                gridPane.add(thoiKy,1,1);
                gridPane.add(new Text("Quê hương: "),0,2);
                gridPane.add(queHuong,1,2);
                gridPane.add(new Text("Kinh đô: "),0,3);
                gridPane.add(kinhDo,1,3);
                gridPane.add(new Text("Thời gian trị vì: "),0,4);
                gridPane.add(triVi,1,4);
                gridPane.add(new Text("Các vua: "),0,5);
                if(cacVua.size() == 0){
                    gridPane.add(new Text("Không rõ"),1,5);
                }else {
                    int i = 0;
                    int j = 0;
                ...
                newWindow.setTitle("Thông tin thời kỳ");
