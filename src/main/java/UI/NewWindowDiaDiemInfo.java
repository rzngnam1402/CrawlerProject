    ...
    public static EventHandler<ActionEvent> DiaDiemInfoWindow(String ten){
        EventHandler<ActionEvent> event =new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                gridPane.add(new Text("Vị trí: "),0,0);
                gridPane.add(viTri,1,0);
                gridPane.add(new Text("Quốc gia: "),0,1);
                gridPane.add(quocGia,1,1);
                gridPane.add(new Text("Địa chỉ: "),0,2);
                gridPane.add(diaChi,1,2);
                gridPane.add(new Text("Thông tin: "),0,3);
                gridPane.add(thongTin,1,3);
                gridPane.add(new Text("Khởi lập"),0,4);
                gridPane.add(khoiLap,1,4);
                gridPane.add(new Text("Tọa độ: "),0,5);
                gridPane.add(toaDo,1,5);
                gridPane.add(new Text("Người sáng lập: "),0,6);
                gridPane.add(nguoiSangLapBtn,1,6);
                gridPane.add(new Text("Lễ hội: "),0,7);
                ...
                if(links.size()!=0) {
                    ...
                    gridPane.add(new Text("Không rõ"),1,8);
                }
                ...
                newWindow.setTitle("Thông tin địa điểm");
